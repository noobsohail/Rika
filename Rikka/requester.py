...
on = tbot.on
auth = tbot.iter_participants(channel, filter=ChannelParticipantsAdmins) 
...
async def ans(e):
    await e.answer("This Request is unavailable... Ask Admins in @Anime_Clan_Group for help. 💞", alert=True, cache_time=0)
